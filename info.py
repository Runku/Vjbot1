...
PICS = (environ.get('PICS', 'https://graph.org/file/ac4089c587b061ed56927.jpg')).split() #SAMPLE PIC
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001729541301').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/BackupByJaggiiRequest') # Support Chat Link Without https:// or @
